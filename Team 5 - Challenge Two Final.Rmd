...
transactional[, last_vend := c(NA, timestamp[-.N]), by=machine] 
...
# Checking if high deltahours has a strong correlation with failure:
...
```{r}
# Profit Increase of medium risk compared to current system:
...
```{r}
# Profit Increase of high risk compared to current system:
